    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:GridView ID="GridViewUsuarios" AutoGenerateColumns="False" EmptyDataText="No hay registros."
                ...
                OnRowCancelingEdit="GridViewUsuarios_RowCancelingEdit"  PageSize="5" OnRowDeleting="GridViewUsuarios_OnRowDeleting" OnPageIndexChanging="GridViewUsuarios_PageIndexChanging" >
                <Columns>
