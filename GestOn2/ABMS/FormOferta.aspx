    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                <div id="DivFiltros" runat="server" class="form-row border border-info col-md-12 col-lg-12 col-sm-12 col-xl-12 mt-2 ml-1 ">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4 mt-3 mt-3" id="Div2" runat="server">
                        <asp:Button ID="btnBuscar" runat="server" class="btn btn-info col-md-5 col-lg-5 col-sm-5  ml-2" Text="Buscar" OnClick="btnBuscar_Click" />
            ...
            <div class="container-fluid col-4 col-lg-4 col-md-4 col-sm-4 col-xl-4 mt-3" runat="server" id="DivNewOferta" visible ="false">
                <div class="row bg-light border border-dark">
                    <div class="col-md-10 col-lg-10 col-sm-10 col-10 col-xl-10 ml-4" runat="server" id="divNuevaOferta">
                        ...
                        <asp:TextBox ID="txtFechaDesde" class="col-12 col-lg-12 col-md-12 col-sm-12 col-xl-12 mt-3" placeholder="06/08/2020" runat="server" TextMode="DateTime"></asp:TextBox>
                        <asp:TextBox ID="txtFechaHasta" class="col-12 col-lg-12 col-md-12 col-sm-12 col-xl-12 mt-3" placeholder="06/09/2020" runat="server" TextMode="DateTime"></asp:TextBox>
