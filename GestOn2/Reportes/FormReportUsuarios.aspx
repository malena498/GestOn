            ...
            <div id="DivFiltros" runat="server" class="container col-md-12 col-lg-12 col-sm-12 col-xl-12 m-0 border bg-light">
                <div class="form-row border-top-0 col-md-12 col-lg-12 col-sm-12 col-xl-12 mt-1">
                    <div class="container-fluid border border-primary p-3 col-md-10 col-lg-10 col-sm-10 col-xl-10 mt-1">
                        ...
                        <asp:DropDownList ID="ddlSeleccionaFiltro" CssClass="form-select p-1 col-4 col-md-4 col-lg-4 col-sm-4" runat="server" OnSelectedIndexChanged="ddlSeleccionaFiltro_SelectedIndexChanged">
                        ...
                        <asp:TextBox ID="txtFecha1" CssClass="col-xl-2 col-sm-2 col-lg-2 col-md-2 ml-3 p-1" runat="server" TextMode="Date"></asp:TextBox>
                        <asp:TextBox ID="txtFecha2" CssClass="col-xl-2 col-sm-2 col-lg-2 col-md-2 p-1" runat="server" TextMode="Date"></asp:TextBox>
                        <asp:LinkButton ID="btnGraficar" CssClass="btn btn-outline-primary col-xl-1 col-sm-1 col-lg-1 col-md-1 ml-2 m-0" runat="server" OnClick="btnGraficar_Click"><i class="fa fa-search"></i></asp:LinkButton><br />
                        <asp:Label ID="lblMensaje" CssClass="alert alert-danger col-xl-6 col-sm-6 col-lg-6 col-md-6 mt-3 " runat="server" Visible="false" Text="Label"></asp:Label>
                    </div>
                </div>
